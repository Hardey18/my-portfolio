...
function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:nurudeenadeolaa@gmail?subject=${formData.subject}&body=Hi, my name is ${formData.name}. ${formData.message} (${formData.email})`;
  };
  return (
    <motion.div
      initial={{ opacity: 0 }}
      ...
      <div className="flex flex-col space-y-10">
        ...
        <div className="space-y-10">
          <div className="flex item-center space-x-5 justify-center">
            ...
            <p className="text-2xl">+2347067959989</p>
          </div>

          <div className="flex item-center space-x-5 justify-center">
            <EnvelopeIcon className="text-[#F7AB0A] h-7 w-7 animate-pulse" />
            <p className="text-2xl">nurudeenadeolaa@gmail.com</p>
          </div>

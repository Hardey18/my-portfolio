  ...
  return (
    <header className="sticky top-0 p-5 flex items-start justify-between max-w-7xl mx-auto z-20 xl:items-center">
        <motion.div initial={{ x: -500, opacity: 0, scale: 0.5 }} animate={{ x: 0, opacity: 1, scale: 1 }} transition={{ duration: 1.5 }} className="flex flex-row items-center">
            <SocialIcon url="https://www.linkedin.com/hardey" fgColor="gray" bgColor="transparent" />
            <SocialIcon url="https://www.twitter.com/hardey" fgColor="gray" bgColor="transparent" />
            <SocialIcon url="https://www.youtube.com/hardey" fgColor="gray" bgColor="transparent" />
        </motion.div>
